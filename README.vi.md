...
1. **Clone repository**
   ...
   ```bash
   git clonehttps://github.com/CTU-SematX/Orion-Nginx.git
   cd Orion-Nginx
   ```
...
Đối với các lỗ hổng bảo mật, vui lòng xem [SECURITY.md](SECURITY.md) để biết quy trình công bố có trách nhiệm.
...
Hướng dẫn chung về _cách_ đóng góp nên được nêu rõ với liên kết đến [CONTRIBUTING](CONTRIBUTING.md).
