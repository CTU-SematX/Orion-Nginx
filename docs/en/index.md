...
[![vi](https://img.shields.io/badge/lang-vi-red.svg)](../vi/)
...
For security vulnerabilities, please see [SECURITY.md](https://github.com/CTU-SematX/Orion-Nginx/blob/main/SECURITY.md) for responsible disclosure procedures.
...
General instructions on _how_ to contribute should be stated with a link to [CONTRIBUTING](https://github.com/CTU-SematX/Orion-Nginx/blob/main/CONTRIBUTING.md).
