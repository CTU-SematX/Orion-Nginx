...
Dự án này được cấp phép theo Giấy phép Creative Commons Attribution 4.0 International - xem file [LICENSES/CC-BY-4.0.txt](https://github.com/CTU-SematX/Orion-Nginx/blob/main/LICENSES/CC-BY-4.0.txt) để biết chi tiết.
